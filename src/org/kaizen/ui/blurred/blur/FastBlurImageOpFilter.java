...
import org.kaizen.ui.blurred.blur.AbstractImageOpFilter;
import java.awt.image.BufferedImage;
import org.kaizen.ui.core.GraphicsUtilities;

public class FastBlurImageOpFilter extends AbstractImageOpFilter {
     ...
     */
    public FastBlurImageOpFilter() {
        this(3);
    }

    /**
     * <p>
     * Creates a new blur filter with the specified radius. If the radius is lower than 1, a radius of 1 will be used automatically.</p>
     *
     * @param radius the radius, in pixels, of the blur
     */
    public FastBlurImageOpFilter(int radius) {
        if (radius < 1) {
            radius = 1;
        }
    ...
    /**
     * <p>
     * Blurs the source pixels into the destination pixels. The force of the blur is specified by the radius which must be greater than 0.</p>
     * <p>
